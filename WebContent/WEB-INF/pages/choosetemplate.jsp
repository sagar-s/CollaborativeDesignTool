          ...
          <div class="col-xs-6 col-xs-offset-3">
              ...
              <div class="radio-inline">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="usecasetemplate" id="inlineRadio1" value="usecasetemplate1" ng-model="customizeusecase" >
                  <img src="bootstrap-theme/Images/USECASE1.JPEG" class="img-rounded" onclick="" alt="Responsive image">
                </label>
                </div>
                <div class="radio-inline">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="usecasetemplate" id="inlineRadio2" value="usecasetemplate2" ng-model="customizeusecase">
