	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-6 col-xs-offset-3">
				...
				<h3 class="alloc "style:"font-family:Arial; margin:50px">Add
					Description</h3>
				<br>

				<form action="choosetemplate" method="POST">
					<div class="form-group ">
						<label for="ProjectName" class="jumboHeading col-2 col-form-label"
							style="font-family: Arial"> Project name </label>
						<div class="col-10">
					...
					<div class="form-group ">
						<label for="ProjectName" class="jumboHeading col-2 col-form-label"
							style="font-family: Arial"> Project Description </label>
						<div class="col-10">
